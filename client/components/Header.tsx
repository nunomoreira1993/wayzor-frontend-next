                  ...
                  <div className="flex items-center gap-1">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M4.25 15.5C4.25 13.4289 5.92893 11.75 8 11.75H12C14.0711 11.75 15.75 13.4289 15.75 15.5V17.5C15.75 17.9142 15.4142 18.25 15 18.25C14.5858 18.25 14.25 17.9142 14.25 17.5V15.5C14.25 14.2574 13.2426 13.25 12 13.25H8C6.75736 13.25 5.75 14.2574 5.75 15.5V17.5C5.75 17.9142 5.41421 18.25 5 18.25C4.58579 18.25 4.25 17.9142 4.25 17.5V15.5Z"
                        fill="#528116"
                      />
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M10 4.25C8.75736 4.25 7.75 5.25736 7.75 6.5C7.75 7.74264 8.75736 8.75 10 8.75C11.2426 8.75 12.25 7.74264 12.25 6.5C12.25 5.25736 11.2426 4.25 10 4.25ZM6.25 6.5C6.25 4.42893 7.92893 2.75 10 2.75C12.0711 2.75 13.75 4.42893 13.75 6.5C13.75 8.57107 12.0711 10.25 10 10.25C7.92893 10.25 6.25 8.57107 6.25 6.5Z"
                        fill="#528116"
                      />
                    </svg>
                    <span className="text-content-dark-medium font-lato font-semibold text-lg leading-[140%]">
