      ...
      <div className="container mx-auto px-4 lg:px-8">
        <nav className="flex items-center justify-between h-[91px] px-4 lg:px-16">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            <a
              href="#"
              className="text-white font-lato font-bold text-base hover:text-wayzor-green transition-colors"
            >
              Vehicles
            </a>
            <a
          ...
          <div className="flex items-center gap-6">
            ...
            <button className="hidden lg:flex items-center px-6 py-3 border-2 border-wayzor-green rounded-full bg-bg-overlay-black-10 backdrop-blur-sm">
              <span className="text-white font-lato font-bold text-sm">
                Fast Check-in
              </span>
            </button>
            ...
            <div className="hidden lg:flex items-center gap-1">
              ...
              <span className="text-white font-lato font-bold text-base">
                Login / Register
              </span>
            </div>
