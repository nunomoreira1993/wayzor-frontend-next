...
const CarCard: React.FC<CarCardProps> = ({ car, className = "" }) => {
  return (
    <div
      className={`group flex flex-col w-full max-w-[303px] mx-auto rounded-xl border border-[rgba(75,56,76,0.20)] bg-white hover:border-wayzor-green hover:shadow-lg transition-all duration-300 cursor-pointer ${className}`}
    >
      {/* Header Section */}
      ...
      <div className="flex flex-col px-6 pt-1 pb-4">
        ...
        <div className="flex items-start gap-2 mb-1">
          <span
            className={`font-lato text-2xl font-bold leading-[130%] ${car.priceColor}`}
          >
