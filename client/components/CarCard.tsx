...
const CarCard: React.FC<CarCardProps> = ({ className = "" }) => {
  ...
  return (
    <div className={`flex flex-col w-[528px] rounded-xl border border-[rgba(75,56,76,0.20)] bg-white ${className}`}>
      {/* Header Section */}
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center gap-1">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M9.06543 1.58265C9.973 0.675085 11.4445 0.675086 12.352 1.58265C13.2596 2.49022 13.2596 3.96168 12.352 4.86924L7.28495 9.93631C7.00197 10.2193 6.63053 10.3967 6.23257 10.4391L3.16992 10.7648L3.49561 7.7021C3.53793 7.30414 3.71538 6.93271 3.99836 6.64972L9.06543 1.58265ZM11.2914 2.64331C10.9696 2.32153 10.4479 2.32153 10.1261 2.64331L10.0475 2.72194L11.2127 3.88721L11.2914 3.80858C11.6131 3.4868 11.6131 2.96509 11.2914 2.64331ZM10.1521 4.94787L8.9868 3.7826L5.05903 7.71038C5.0186 7.75081 4.99325 7.80387 4.9872 7.86072L4.85788 9.07679L6.07395 8.94747C6.13081 8.94142 6.18387 8.91607 6.22429 8.87565L10.1521 4.94787ZM3.25094 14C3.25094 13.5858 3.58672 13.25 4.00094 13.25H10.5009C10.9152 13.25 11.2509 13.5858 11.2509 14C11.2509 14.4142 10.9152 14.75 10.5009 14.75H4.00094C3.58672 14.75 3.25094 14.4142 3.25094 14Z" fill="#528116"/>
              </svg>
