            ...
            <CardContent className="p-8">
              <div className="flex flex-col gap-8">
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-wayzor-green flex items-center justify-center">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                        d="M21.7955 6.20455C22.2348 6.64384 22.2348 7.35616 21.7955 7.79545L10.7955 18.7955C10.3767 19.2142 9.71493 19.2367 9.26837 18.8467L2.26837 12.8467C1.79168 12.4292 1.74423 11.7177 2.16168 11.2411C2.57912 10.7644 3.29061 10.7169 3.76729 11.1344L9.46875 16.2302L20.2045 5.20455C20.6438 4.76526 21.3562 4.76526 21.7955 6.20455Z"
                        fill="black"
                      />
                    </svg>
                  </div>
                  <div>
                    ...
                    <p className="text-content-dark-medium font-lato text-base font-normal leading-[150%] mt-2">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  {/* Car Information */}
                  <div className="flex flex-col gap-4 p-4 bg-[#4B384C]/10 rounded-lg">
                  ...
                  <div className="flex gap-12">
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-content-bodytext font-lato text-sm font-normal leading-[123%]">
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex items-center justify-between p-3 bg-[#4B384C]/10 rounded-lg">
                        <div className="flex items-center gap-2">
                          ...
                          <svg width="16" height="17" viewBox="0 0 16 17" fill="none">
                            <path
                              ...
                              fill="#528116"
                            />
                            <path d="M8.75 11.75C8.75 12.1642 8.41421 12.5 8 12.5C7.58579 12.5 7.25 12.1642 7.25 11.75C7.25 11.3358 7.58579 11 8 11C8.41421 11 8.75 11.3358 8.75 11.75Z" fill="#528116"/>
                          </svg>
                        </div>
                        <div className="w-6 h-6 rounded-full bg-[#4B384C] flex items-center justify-center">
                  ...
                  {/* Total Price */}
                  <div className="flex justify-end items-end gap-2 py-6">
                    <div className="text-right">
                      <p className="text-content-label font-lato text-xs font-normal leading-[150%] mb-1">
                        valor da totalidade da reserva IVA incluído
                      </p>
                      <p className="text-content-dark-medium font-lato text-[32px] font-bold leading-[125%]">
                        € 44,52 *
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-4">
                      <Input
                        ...
                        className="h-14 rounded-lg border-[#000]/10 placeholder:text-content-label max-w-[325px]"
                      />
                      <Button
                        variant="outline"
                        className="h-10 px-6 border-wayzor-green-dark text-wayzor-green-dark hover:bg-wayzor-green-dark hover:text-white rounded-full"
                      >
                        Validate
                      </Button>
                    </div>
                  ...
                  {/* Continue Button */}
                  <Button
                    className="w-full h-[54px] bg-wayzor-green hover:bg-wayzor-green/90 text-black font-lato text-base font-bold rounded-full"
                  >
                    Continue the reserve
                  </Button>

                  {/* Terms */}
                  <div className="text-content-label font-lato text-sm font-normal leading-[150%] max-w-[473px]">
                    * At the time of pick up the vehicle:<br />
                    - € 600,00 Security Deposit on the same physical credit card as the online payment, on behalf of the driver.<br />
                    - Security Deposit will be returned upon termination of contract.
                  </div>
                </div>
              </div>
            </CardContent>
